...
public class AnalisadorSintatico {
	...
	public void expressao(){
		if(tokens.get(i).getValor().equals("U") || tokens.get(i).getValor().equals("⊆") ||
		tokens.get(i).getValor().equals("⊂") || tokens.get(i).getValor().equals("∩") || tokens.get(i).getValor().equals("pos")){
			expreConj();
		}
		else{
			expreNum();
